...
function App() {
  ...
  useEffect(() => {
    ...
    const effect=document.querySelector("#hower h1");
    effect.addEventListener("mouseenter",function(dets){
    ...
    effect.addEventListener("mouseleave",function(dets){
      cursor.innerHTML="click"
      gsap.to("#cursor",{
        scale:1, 
  ...
  return (
    <>
    <div id="main">
    <div id="cursor" className="h-5 w-5 rounded-full bg-white">  
    </div>
      <span
        ref={growingSpan}
      ...
      <div className="w-full relative min-h-screen font-['Helvetica_Now_Display']">
        ...
        <div className="w-full relative z-[1] h-screen ">
          ...
          <div id="hower" className="w-full absolute bottom-0 left-0">
            <h1
              ref={headingref}
